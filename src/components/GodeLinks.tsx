...
const GodeLinks = () =>  {
    return (
        <div className="grid grid-cols-1 w-1/3 xs:w-3/4 sm:w-3/4 md:w1/3 lg:w1/3 xl:w1/3 2xl:w1/3 gap-4 ml-auto mr-auto pt-2">
            ...
            <button className="btn btn-block ltbtn bg-black hover:bg-gray-800" onClick={() => openInNewTab('https://github.com/godeProject/godeAPI')}><i className="bi bi-github mx-2 text-lg"></i>godeAPI (Rest API)</button>
            ...
            <button className="btn btn-block ltbtn bg-[#4584b6] hover:bg-[#5097d1]" onClick={() => openInNewTab('https://pypi.org/project/pygode')}><PythonIcon />pygode (ไลบรารีภาษา Python)</button>
